...
class DialogBox(sge.gfx.Sprite):
    def __init__(self, char_sprite, font, text):
        self.id = None      #This is filled by the Generator at instantiation.
        self.text = text
        self.font = font
...
#    def event_step(self, time_passed, delta_mult):
    ...
    def render(self):
        self.draw_text(font=self.font, text=self.text, color=sge.gfx.Color("red"), x=0, y=0, frame=None)
